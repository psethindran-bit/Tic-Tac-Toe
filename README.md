...
<title>DEV Tech's Tic Tac Toe</title>
<style>
  body {
    ...
    align-items: center;
    background: 
      linear-gradient(135deg, rgba(12,236,188,0.7), rgba(30,144,255,0.7)),
...
<script>
  ...
  function startGame() {
    ...
    winLength = gridSize === 3 ? 3 : 4; // To win: 3 for 3x3, 4 for 4x4
    ...
    // If AI starts (human chose O and mode not human)
  ...
  function makeMove(idx, player) {
    ...
    // Message about next turn will be updated after switchPlayer.
  }
